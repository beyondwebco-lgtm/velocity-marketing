        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <ul className="space-y-4 text-xs text-slate-300 font-medium">
              <li>
                <a href="https://www.instagram.com/velocitymarketing_btl?igsh=MWVxejEwYmp2djc3Yw==" target="_blank" rel="noopener noreferrer" aria-label="Velocity Marketing Instagram" className="flex items-center space-x-2 hover:text-blue-400 transition-colors">
