        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-slate-900/5 border border-slate-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {PROCESS.map((step, index) => (
              <div key={index} className="flex items-start space-x-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
            ...
            return (
              <div key={service.id} className={`flex flex-col lg:flex-row gap-12 items-center ${isEven ? '' : 'lg:flex-row-reverse'}`}>
                ...
                <div className="w-full lg:w-1/2 space-y-6">
                  <div className="inline-block px-3 py-1 rounded-full bg-blue-100 text-blue-800 text-xs font-bold font-mono tracking-wider">
                    SERVICE {service.id}
                  </div>
                  ...
                  <div className="pt-6">
                    <button
                      onClick={onOpenQuote}
                      className="inline-flex items-center space-x-2 px-6 py-3 rounded-full bg-slate-900 hover:bg-blue-600 text-white font-bold transition-all duration-300 shadow-md"
                    >
